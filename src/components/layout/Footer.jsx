      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-branding">
            <h2 className="footer-logo">NSAT Prep</h2>
            <p className="footer-tagline">
              Your one-stop destination for NSAT preparation resources.
            </p>
          ...
          <div className="footer-links">
            ...
            <ul className="footer-link-list">
              <li><a href="#">Home</a></li>
              <li><a href="#about">About NSAT</a></li>
          ...
          <div className="footer-contact">
            ...
            <p className="footer-contact-info">
              ...
              <a href="mailto:contact@nsatprep.com">contact@nsatprep.com</a>
            </p>
            <p className="footer-contact-info">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            &copy; {currentYear} NSAT Preparation. All rights reserved.
          </div>
